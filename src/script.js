...
const forceAudio = new Audio('./sound/calling you.mp3');
...
const songs = [
  { ele: cartoonAudio, audioName: ' "Honey bird " ' },
  { ele: forceAudio, audioName: ' " Nano Pick up call " ' },
  { ele: squeakyAudio, audioName: ' " Squeaky Sound " ' },
  { ele: hopeAudio, audioName: ' "  Positive Hope "' },
